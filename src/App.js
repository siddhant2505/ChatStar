...
function App() {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost:9000/testAPI').then((res) => res.text()).then((res) => console.log(res));
    
  }, []);

	const alanKey = '6850334add5869853e8023acb95b933e2e956eca572e1d8b807a3e2338fdd0dc/stage';
...
const rooms = [
	...
	},
	{
		...
		urlImage: 'https://lh3.googleusercontent.com/z5nin1RdQ4UZhv6fa1FNG7VE33imGqPgC4kKZIUjgf_up7E-Pj3AaojlMPwNNXaeGA'
	},
	{
		name: 'FAMILY',
		...
		urlImage: 'https://i.pinimg.com/originals/b4/4c/2f/b44c2f7347d47a3d4bdab60481239e20.jpg'
	}
];
